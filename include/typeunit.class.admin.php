    ...
    function ListAllType($channel=0,$nowdir=0)
    {
        ...
        while($row = $this->dsql->GetObject(0))
        {
            ...
            if($ispart==0)
            {
                ...
                echo "<a href='{$GLOBALS['cfg_phpurl']}/list.php?tid={$id}' target='_blank'>预览1</a>";
                echo "|<a href='catalog_do.php?cid={$id}&dopost=listArchives'>内容1</a>";
            ...
            else if($ispart==1)
            {
                ...
                echo "    </td><td align='right'>";
                echo "<a href='{$GLOBALS['cfg_phpurl']}/list.php?tid={$id}' target='_blank'>预览2</a>";
